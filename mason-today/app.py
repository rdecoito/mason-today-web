...
@app.route("/")
def display_default():
    resp = Response(("Welcome to the masontoday API! Go to https://git.gmu.edu\
                     /srct/mason-today-web <br/><br/>"
                     + "Feel free to go to /api/25live/ or /api/getconnected/ \
                     to find our api!").encode('utf-8'))
    return resp
